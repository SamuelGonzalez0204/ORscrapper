...
ORscrapper is an R package designed to extract relevant medical
...
extraction and processing of information from report files. ORscrapper
...
Below is a basic example of how to use ORscrapper to extract information
from PDF files:
